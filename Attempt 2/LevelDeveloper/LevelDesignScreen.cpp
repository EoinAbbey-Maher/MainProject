...
#include "ui_LevelDesignScreen"
#include <QMenu>
#include <QMenuBar>


LevelDesignScreen::LevelDesignScreen(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::LevelDesignScreen)
{
    ui->setupUi(this);
...
void LevelDesignScreen::handleApplyButton()
{
...
void LevelDesignScreen::handleClearButton()
{
...
void LevelDesignScreen::handleExportButton()
{
    m_xmlWriter.WriteTilesToFile(m_mapTable, m_TexturePaths);
}

void LevelDesignScreen::createActions()
{
...
// ------------------------------------------------------------------------------------
void LevelDesignScreen::setTextures()
{
...
// ------------------------------------------------------------------------------------
void LevelDesignScreen::removeTextures()
{
...
//            Assign Textures From Button Press
// ------------------------------------------------------------------------------------
void LevelDesignScreen::setupIcons()
{
...
//            Assign Textures From Button Press
// ------------------------------------------------------------------------------------
void LevelDesignScreen::setupGameGrid()
{       
...
void LevelDesignScreen::wheelEvent(QWheelEvent *t_event)
{
    if(t_event->delta() > 0)
    {
...
void LevelDesignScreen::keyPressEvent(QKeyEvent *t_event)
{
